...
// Environments builds the old-style environment map for backward compatibility.
// For now, everything goes into a single "default" environment.
func (cfg *Config) Environments() map[string][]HostConfig {
